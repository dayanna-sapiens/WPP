...
{
    public class CostoHoraMapping : ClassMap<CostoHora>
    {
        public CostoHoraMapping()
        {
            Table("CostoHora");
            Id(x => x.Id).GeneratedBy.Sequence("SEQ_CostoHora");
            Version(u => u.Version);
            ...
            Map(r => r.FechaFin).Not.Nullable();
            Map(r => r.FechaInicio).Not.Nullable();
